...
@Component
public class AutoreWebSocketHandler extends TextWebSocketHandler {
    ...
    // Quando un client invia un messaggio, lo gestiamo (ad esempio, inviamo una notifica)
    @Override
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        // Gestisci il messaggio ricevuto (ad esempio, invia una notifica a tutti)
        System.out.println("Messaggio ricevuto per Autore: " + message.getPayload());
    }
